...
/**
 * Component that render a template for all Pages
 * @param PropsWithChildren<PageProps>
 * @returns JSX.Element
 */
export const Page = ({ title, search, children }: PropsWithChildren<PageProps>): JSX.Element => {
  ...
  return (
    <>
      ...
      <Grid container className="page-root" direction="row" justifyContent="center" alignItems="center">
